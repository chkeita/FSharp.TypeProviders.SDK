...
module Misc =
    ...
    let mkCompilationMappingAttribute() =
        { new CustomAttributeData() with
            member __.Constructor = typeof<CompilationMappingAttribute>.GetConstructor([|typeof<SourceConstructFlags>|])
            member __.ConstructorArguments = upcast [| CustomAttributeTypedArgument SourceConstructFlags.RecordType |]
            member __.NamedArguments = upcast [| |]
        }
    ...
    let mkCompilationMappingForFields fieldIndex =
        { new CustomAttributeData() with
            member __.Constructor = typeof<CompilationMappingAttribute>.GetConstructor([|typeof<SourceConstructFlags>; typeof<int>|])
    ...
    let mkCompilerGeneratedAttribute () =
        { new CustomAttributeData() with
            member __.Constructor = typeof<System.Runtime.CompilerServices.CompilerGeneratedAttribute>.GetConstructor([||])
            member __.ConstructorArguments = upcast [||]
            member __.NamedArguments = upcast [| |]
        }
    ...
    let mkDebuggerBrowsableAttribute () =
        { new CustomAttributeData() with
            member __.Constructor = typeof<System.Diagnostics.DebuggerBrowsableAttribute>.GetConstructor [|typeof<System.Diagnostics.DebuggerBrowsableState>|]
